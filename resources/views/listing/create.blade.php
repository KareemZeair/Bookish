            ...
            <div class="col d-flex justify-content-center">
                <div class="card " style="margin-top: 50px; width: 60%">
                    <div class="card-header" style="background-color: #4d587d; color: white; text-align: center;">
                        Adding <span style="text-decoration:underline">{{ $book->title }}</span> to a listing: </div>
                            ...
                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="contact" value="{{old('contact')}}" class="form-control mb-2" placeholder="yourcontact@email.com" name="contact" id="contact" required>
                                </div>
                                @error("contact")
                                <p style="color: red;" class="text-xs mt-1">{{ $message }}</p>
                                @enderror
